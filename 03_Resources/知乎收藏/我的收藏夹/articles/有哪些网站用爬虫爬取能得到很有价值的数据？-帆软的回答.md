...
collected: "2021-04-13"
created: "2026-08-20"
tags: ["知乎", "收藏"]
source: "https://www.zhihu.com/question/36132174/answer/1832434682"
author: "帆软"
---

提醒一句：python爬取数据是个挺有意思的事情，但是！！！（此处肯定有个转折），一些不该爬的网站或者数据就不要碰了，这点要注意一下。

获取数据不一定要用爬虫呀，有时候python爬出来的数据也不一定能有多大的分析价值，想要获取数据还不简单，帆软君这里有多个数据网站，涉及到各行各业，数据的价值也很大，可以直接拿来做分析。

而且题主是想从程序员转行到数据分析，重要的不是数据，而是整个分析方法和思维逻辑，帆软君在文末也整理好了~
